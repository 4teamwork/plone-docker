# Copied from plone.app.theming 1.1.8
# Fix encoding issues in theming transforms.
# When parsing HTML, encoding detection doesn't work reliably. If an UTF-8
# encoded byte string contains non-ascii characters, ISO-8859-1 encoding may
# be detected. This patch sets the encoding manually to UTF-8 as we are not
# using other encodings.
#
# The problem seems to only happen with recent Alpine Linux.
# The behavior can be reproduced with the following snippet, which should
# return 'UTF-8', but returns 'ISO-8859-1':
#
# >>> from lxml.html import HTMLParser
# >>> parser = HTMLParser()
# >>> parser.feed(b'<div><h2>Schlagw\xc3\xb6rter</h2></div>')
# >>> parser.close().getroottree().docinfo.encoding
# 'ISO-8859-1'
